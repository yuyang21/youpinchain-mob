                    ...
                    <section class="order_item_top">
                        <section>
                            ...
                            <template v-for="group in groupOrder">
                                <router-link v-if="group.groupMyId == item.groupMyId"
                                             ...
                                             class="order_item_top_header_group" tag="header">
                                    <ul>
                        ...
                        <div class="order_item_bottom">
                            ...
                            <div class="order_again">
                                ...
                                <router-link tag="span" to="/home" class="order_button_red"
                                             v-if="item.handleOption.rebuy">再次购买
                                </router-link>
                            </div>
                        </div>
                    </section>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            upCallback(page) {
                getOrderList(page.num, page.size, 101).then(res => {
