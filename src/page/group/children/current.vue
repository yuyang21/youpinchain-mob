        ...
        <div class="mescroll" ref="mescroll">
            ...
            <section id="hot_goods">
                <ul class="goodslistul clear">
                    <router-link tag="li" :to="'/goods/' + item.id + '/' + item.brandId" class="overflow-hi" v-for="item in goOn" :key="item.id">
                        ...
                        <div class="goods_info">
                            ...
                            <div class="left">
                                <p class="price"><span class="lable">拼团更划算</span><span class="RMB">￥</span>{{item.minimumPrice || item.presentPrice}}</p>
...
<script>
    ...
    export default {
        ...
        methods: {
            upCallback (page) {
                getProducts(page.num, page.size).then(res => {
                    ...
                    setTimeout(function () {
                        ...
                        that.$nextTick(() => {
                            that.mescroll.endSuccess(arr.length, page.num < res.data.totalPage);
                        })
                    },300)
